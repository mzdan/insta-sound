...
plot_nyc_web_images <- function(posts, path) {
    ...
    save_plot('neighborhood_stats', plot_neighborhood_stats(neighborhood_stats), 10, 9)
    save_plot('neighborhood_stats_log_scale', plot_neighborhood_stats_log_scale(neighborhood_stats), 10, 9)
